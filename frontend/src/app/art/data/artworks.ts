...
const CDN = 'https://cdn.jsdelivr.net/gh/Asalsr/CV@master/frontend/public';
...
export const artworks: Artwork[] = [
  {
    ...
    year: '2021',
    thumbnail: `${CDN}/art/hatch/2_1.webp`,
    images: [
      `${CDN}/art/hatch/2_1.webp`,
      `${CDN}/art/hatch/2_2.webp`,
      `${CDN}/art/hatch/2_4.webp`,
      `${CDN}/art/hatch/2_5.webp`,
      `${CDN}/art/hatch/2_6.webp`,
      `${CDN}/art/hatch/2_7.webp`,
      `${CDN}/art/hatch/2_8.webp`,
      `${CDN}/art/hatch/2_10.webp`,
      `${CDN}/art/hatch/2_11.webp`,
      `${CDN}/art/hatch/2_12.webp`,
    ],
    type: 'image',
...
Shot using natural lighting to emphasize organic textures and forms. Post-processing focused on maintaining authenticity while enhancing the emotional impact of each frame.`,
  ...
  },
  {
    ...
    category: 'Painting',
    year: '2022',
    thumbnail: `${CDN}/art/war/1.webp`,
    images: [
      `${CDN}/art/war/1.webp`,
      `${CDN}/art/war/MATTOCK-3.webp`,
      `${CDN}/art/war/MATTOCK-5.webp`,
      `${CDN}/art/war/pittura%202-1.webp`,
      `${CDN}/art/war/pittura%202-2.webp`,
      `${CDN}/art/war/pittura%202-3.webp`,
      `${CDN}/art/war/Sarcofago%20Grande%20Ludovisi.webp`,
      `${CDN}/art/war/IMG_3791.webp`,
      `${CDN}/art/war/z.webp`,
    ],
    type: 'image',
...
Mixed media illustrations combining traditional drawing with digital enhancement. The raw, expressive style intentionally contrasts with the refined aesthetics of classical war art.`,
  ...
  },
  {
    ...
    category: 'Painting',
    year: '2015-2018',
    thumbnail: `${CDN}/art/paintings/a1.webp`,
    images: [
      `${CDN}/art/paintings/a1.webp`,
      `${CDN}/art/paintings/a2.webp`,
      `${CDN}/art/paintings/a4.webp`,
      `${CDN}/art/paintings/a6.webp`,
      `${CDN}/art/paintings/a8.webp`,
      `${CDN}/art/paintings/a9.webp`,
      `${CDN}/art/paintings/IMG_7605.webp`,
      `${CDN}/art/paintings/IMG_7620.webp`,
      `${CDN}/art/paintings/IMG_1024.webp`,
      `${CDN}/art/paintings/IMG_1034.webp`,
      `${CDN}/art/paintings/IMG_1039.webp`,
      `${CDN}/art/paintings/IMG_1049.webp`,
      `${CDN}/art/paintings/IMG_1050.webp`,
      `${CDN}/art/paintings/IMG_1054.webp`,
      `${CDN}/art/paintings/IMG_1057.webp`,
      `${CDN}/art/paintings/IMG_1062.webp`,
      `${CDN}/art/paintings/IMG_1065.webp`,
      `${CDN}/art/paintings/IMG_1068.webp`,
      `${CDN}/art/paintings/IMG_1077.webp`,
    ],
    type: 'image',
...
Primarily acrylic on canvas, with some works incorporating mixed media elements. The collection showcases the development of a personal visual language over three years of intensive practice.`,
  ...
  },
  {
    ...
    year: '2023',
    thumbnail: `${CDN}/art/liberi-di-crescere/7.webp`,
    images: [
      `${CDN}/art/liberi-di-crescere/7.webp`,
      `${CDN}/art/liberi-di-crescere/copy.webp`,
      `${CDN}/art/liberi-di-crescere/photo_1_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_2_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_3_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_4_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_5_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_6_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_7_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_8_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_9_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_10_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_11_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_12_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_13_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_14_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_15_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_16_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_19_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_20_2026-02-04_17-08-54.webp`,
      `${CDN}/art/liberi-di-crescere/photo_21_2026-02-04_17-08-54.webp`,
    ],
    type: 'image',
...
Clean, professional aesthetic with attention to lighting, composition, and post-processing that enhances without overwhelming the subject. Each project is tailored to the client's brand identity and marketing needs.`,
  ...
  },
  {
    ...
    category: 'Photography',
    year: '2022-2023',
    thumbnail: `${CDN}/art/ForIran/1.webp`,
    images: [
      `${CDN}/art/ForIran/1.webp`,
      `${CDN}/art/ForIran/443A4611.webp`,
      `${CDN}/art/ForIran/443A4643.webp`,
      `${CDN}/art/ForIran/443A4682.webp`,
      `${CDN}/art/ForIran/443A4686.webp`,
      `${CDN}/art/ForIran/443A4690.webp`,
      `${CDN}/art/ForIran/443A4695.webp`,
      `${CDN}/art/ForIran/443A4718.webp`,
      `${CDN}/art/ForIran/443A4744.webp`,
      `${CDN}/art/ForIran/443A4839.webp`,
      `${CDN}/art/ForIran/443A4842.webp`,
      `${CDN}/art/ForIran/443A4889.webp`,
      `${CDN}/art/ForIran/443A4967.webp`,
      `${CDN}/art/ForIran/443A4970.webp`,
      `${CDN}/art/ForIran/443A5110.webp`,
      `${CDN}/art/ForIran/443A5130.webp`,
      `${CDN}/art/ForIran/443A5194.webp`,
      `${CDN}/art/ForIran/443A5198.webp`,
      `${CDN}/art/ForIran/IMG_2921.webp`,
      `${CDN}/art/ForIran/IMG_E3046.webp`,
    ],
    type: 'image',
...
Beyond documentation, this project represents a personal connection to the struggle for human rights and the power of collective action across borders.`,
  ...
  },
  {
    ...
    category: 'Painting',
    year: '2021-2022',
    thumbnail: `${CDN}/art/plastic-blue/final-prova-27.webp`,
    images: [
      `${CDN}/art/plastic-blue/final-prova-27.webp`,
      `${CDN}/art/plastic-blue/20220128_152247.webp`,
      `${CDN}/art/plastic-blue/20220128_152336.webp`,
      `${CDN}/art/plastic-blue/20220128_152420.webp`,
      `${CDN}/art/plastic-blue/20220128_152500.webp`,
      `${CDN}/art/plastic-blue/saeedeh-sarrmadi-4.webp`,
    ],
    type: 'image',
...
Aligned with Goals 3, 6, 12, 13, 14, and 15 — addressing health, clean water, responsible consumption, climate action, and life below water and on land.`,
  ...
  },
  {
    ...
    year: '2022',
    thumbnail: `${CDN}/art/craftswomenship/1-logo.webp`,
    images: [
      `${CDN}/art/craftswomenship/1-logo.webp`,
      `${CDN}/art/craftswomenship/business-card-2.webp`,
      `${CDN}/art/craftswomenship/INSTAGRAM.webp`,
    ],
    type: 'image',
...
The brand identity emphasizes authenticity, craftsmanship, and the personal touch that distinguishes handmade products. The visual language balances modern aesthetics with artisanal warmth.`,
  ...
  },
  {
    ...
    category: 'Graphic Design',
    year: '2020-2021',
    thumbnail: `${CDN}/art/logo-design/pale-1.webp`,
    images: [
      `${CDN}/art/logo-design/pale-1.webp`,
      `${CDN}/art/logo-design/pale-2.webp`,
      `${CDN}/art/logo-design/pale-3.webp`,
      `${CDN}/art/logo-design/pale-4.webp`,
      `${CDN}/art/logo-design/pale-5.webp`,
      `${CDN}/art/logo-design/logo.webp`,
      `${CDN}/art/logo-design/1.webp`,
      `${CDN}/art/logo-design/2.webp`,
      `${CDN}/art/logo-design/Untitled-2.webp`,
      `${CDN}/art/logo-design/blueblue2.webp`,
      `${CDN}/art/logo-design/matrix.webp`,
      `${CDN}/art/logo-design/tars%20film1.webp`,
    ],
    type: 'image',
...
- Promotional graphics`,
  ...
  },
  {
    ...
    category: 'Mural Art',
    year: '2017',
    thumbnail: `${CDN}/art/mural-painting/mural.webp`,
    images: [
      `${CDN}/art/mural-painting/mural.webp`,
      `${CDN}/art/mural-painting/mural-2.webp`,
      `${CDN}/art/mural-painting/mural-3.webp`,
      `${CDN}/art/mural-painting/443A0014.webp`,
      `${CDN}/art/mural-painting/443A0021.webp`,
      `${CDN}/art/mural-painting/443A0041.webp`,
      `${CDN}/art/mural-painting/443A0046.webp`,
      `${CDN}/art/mural-painting/443A0051.webp`,
      `${CDN}/art/mural-painting/443A0064.webp`,
      `${CDN}/art/mural-painting/443A9998.webp`,
      `${CDN}/art/mural-painting/IMG_20161208_121523.webp`,
      `${CDN}/art/mural-painting/IMG_20170110_233038.webp`,
      `${CDN}/art/mural-painting/IMG_20170110_233132.webp`,
      `${CDN}/art/mural-painting/IMG_20170111_103631.webp`,
      `${CDN}/art/mural-painting/IMG_20170111_103635.webp`,
      `${CDN}/art/mural-painting/IMG_20170111_103649.webp`,
      `${CDN}/art/mural-painting/IMG_20170111_103706.webp`,
      `${CDN}/art/mural-painting/Untitled-1.webp`,
    ],
    type: 'image',
...
This project represents a personal exploration of cultural roots and the ongoing dialogue between tradition and modernity.`,
  ...
  },
  {
    ...
    category: 'Workshop/Illustration',
    year: '2022-2023',
    thumbnail: `${CDN}/art/women-life-freedom/443A4382.webp`,
    images: [
      `${CDN}/art/women-life-freedom/443A4382.webp`,
      `${CDN}/art/women-life-freedom/443A4389.webp`,
      `${CDN}/art/women-life-freedom/443A4417.webp`,
      `${CDN}/art/women-life-freedom/443A4418.webp`,
      `${CDN}/art/women-life-freedom/443A4420.webp`,
      `${CDN}/art/women-life-freedom/443A4489.webp`,
      `${CDN}/art/women-life-freedom/443A4553.webp`,
    ],
    type: 'image',
